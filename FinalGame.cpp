...
void printinstructions()
{
	...
	cout<<"\t3. THE PLAYER CAN MAKE AT MAX 10 WRONG PREDICTIONS\n";
	cout<<"\t4. THE COUNT WILL BE REDUCED ON EVERY WRONG PREDICTION AND A PART OF HANGMAN WILL BE DISPLAYED ON THE SCREEN \n";
	cout<<"\t5. IF THE PLAYER MAKES 10 WRONG PREDICTIONS, THEN THE HANGMAN WILL BE HANGED TO DEATH AND PLAYER LOOSES. \n";
